 const marcas = [
  ...
  console.log("problema 1: marcas de productos");
...
console.log("problema 2: productos con mayor existencia");
...
console.log("problema 3: heroes por ciudad");
...
console.log("problema 4 promedio de edades");
